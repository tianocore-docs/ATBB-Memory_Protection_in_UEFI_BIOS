...
a.	``` [BuildOptions.common.EDKII.DXE_SMM_DRIVER, BuildOptions.common.EDKII.SMM_CORE]
b.	MSFT:*_*_*_DLINK_FLAGS = /ALIGN:4096 
c.	GCC:*_*_*_DLINK_FLAGS = -z common-page-size=0x1000```
